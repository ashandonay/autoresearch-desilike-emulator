...
DATA_DIR = os.path.join(_BASE_DIR, ANALYSIS, QUANTITY, "training_data", f"v{DATA_VERSION}")
...
if __name__ == "__main__":
    print(f"\nAnalysis: {ANALYSIS}, Quantity: {QUANTITY}, Version: v{DATA_VERSION}, Tracer: {TRACER or '(none)'}")
